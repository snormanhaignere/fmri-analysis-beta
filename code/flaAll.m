...
for i = 1:length(usubs)
    ...
    for j = 1:length(runtypes)
        ...
        for k = 1:length(runnum)
            ...
            switch exp
                case {'voice_localizer_human','voice_localizer_monkey','amusia','color_monkey','naturalsound_monkey','pitch_localizer_monkey','pitch_localizer_human','tonotopy_monkey','pitch_f0adapt_v3','pitch_f0adapt_v4','pitch_f0adapt_v5','pitch_f0adapt_v6','pitch_f0adapt_v7','pitch_dp_v2','music_scram','music_scram_familiar','pitch_overlap_v2','pitch_overlap_v3','pitch_adapt_params','naturalsound','pitch_adapt_params_v2','pitch_adapt_params_v3'}
