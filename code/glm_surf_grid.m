...
for i = 1:n_maps
    ...
    for q = 1:2
        ...
        try
            ...
            figure_file = [figure_directory '/' runtype '_r' sprintf('%d', I.runs) '_pmap_' I.stat_to_plot '_' ...
            ...
            if I.write_surf_file
                surf_file = [figure_directory '/' runtype '_r' sprintf('%d', I.runs) '_pmap_' I.stat_to_plot '_' ...
