function fla_regression_weighted_boxcars(exp, us, runtype, r, hrf_name, input_data_type, input_fname, output_directory_name, varargin)
...
if optInputs(varargin, 'monkey')
    ...
    surface_directory = [preprocessing_directory '/fsaverage'];
end
...
parafile = [root_directory '/data/para/usub' num2str()]
